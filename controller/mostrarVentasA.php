<?php
            ...
            echo '
              <tr>
                  ...
                  <td style="width: 135px; min-width:135px">
                    ...
                    <button class="btn btn-danger" onclick="return confirmarBorrar()"><i class="fas fa-trash-alt"></i></button>
                  </td>
              </tr>
                ...
                function confirmarBorrar(){
                  Swal.fire({
                    ...
                    if (result.isConfirmed) {
                      location.href="../../controller/eliminarVentasA.php?id_factura='.$f["ID_factura"].'";
                    }
                  })
                }
              </script>';
  ...
  function cargarInfoVenta(){
    ...
    $result = $objetoConsultas->buscarVentaA($ID_factura);
      ...
      <form action="../../controller/updateVentaA.php" method="POST">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    <label for="FechaImput">Fecha y hora</label> 
  ...
  function verFactura(){
    ...
    echo'
        ...
        <div class="row invoice-info">
          ...
          <!-- /.col -->
          <div class="col-sm-3 invoice-col">
            <strong>Id de factura</strong> <br>
            <p>'.$f["ID_factura"].'</p>
          </div>
          <div class="col-sm-3 invoice-col">
