<?php
    ...
    if (empty($id_empleado) || !is_numeric($id_empleado)) {
        ...
        $result = $objetoConsultas->updatePerfilA($id_empleado, $tipoDoc, $numDoc, $nombres, $apellidos, $direccion, $email, $celular, $telefono, $eps, $cajaCompensacion, $arl, $fondoPension, $genero, $rol, $estado, $sueldo);
    } else {
