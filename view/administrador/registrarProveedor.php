...
<head>
  ...
  <title>Registro Proveedor | Uruz</title>
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-danger card-outline">
              <div class="card-header">
                <h5 class="m-0">Formulario para el registro de un proveedor</h5>
              </div>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" name="nitProveedor" class="form-control" id="nitProvee" placeholder="Nit de la empresa del proveedor" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="nombreEmpresa">Nombre de la empresa del proveedor</label>
                      <input type="text" name="nombreEmpreProvee" class="form-control" id="nombresImput" placeholder="Nombre de la empresa" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="telefonoEmpreProv">Teléfono de la empresa del proveedor</label>
                      <input type="number" name="telefonoEmpreProvee" class="form-control" id="telefonoEmpreProv" placeholder="Teléfono directo a la empresa" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="direccionProvee">Dirección de la empresa del proveedor</label>
                      <input type="text" name="direccionEmpreProvee" class="form-control" id="direccionProvee" placeholder="Dirección principal de la empresa" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="nombreContacProvee">Nombre del contacto</label>
                      <input type="text" name="nombreContProvee" class="form-control" id="nombreContacProvee" placeholder="Nombre del principal contacto" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="telefonoInput">Teléfono del contacto</label>
                      <input type="number" class="form-control" name="telefonoContProvee" id="telefonoInput" placeholder="No. de teléfono del contacto" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="correoInput">Email del contacto</label>
                      <input type="email" class="form-control" name="correoContProvee" id="correoInput" placeholder="Email del contacto" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
