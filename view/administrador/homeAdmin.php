<?php
  ...
  require_once("../../controller/administrador/seguridadAdmin.php");
  // perfil
  require_once("../../controller/administrador/perfilAdmin.php");
          ...
          <div class="col-lg-6">
            <div class="col-lg-12">
              <div class="card card-danger card-outline">
                ...
                <div class="card-body">
                  <h6 class="card-title">Vista De Los Empleados</h6>
                  <p class="card-text">Si quiere ir a la vista de sus empleados en la empresa, haga clic en el botón de abajo.</p>
                  <a href="verEmpleados.php" class="btn btn-danger">Comenzar</a>
                </div>
              </div>
            </div>
            <div class="col-lg-12">
              <div class="card card-danger card-outline">
                ...
                <div class="card-body">
                  ...
                  <a href="registrarInventarioProductos.php" class="btn btn-danger">Comenzar</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card card-danger card-outline">
                ...
                <div class="card-body">
                  ...
                  <a href="registrarVenta.php" class="btn btn-danger">Comenzar</a>
                </div>
              </div>
            </div>
          </div>
