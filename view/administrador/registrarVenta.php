        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-danger card-outline">
              ...
              <form id="formularioV" action="../../controller/insertVenta.php" method="POST">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" class="form-control" name="Cod_producto" id="codigoImput" placeholder="Codigo del producto" required>
                    </div>
                    <div class="form-group col-md-6">
