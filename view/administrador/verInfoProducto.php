...
<head>
  ...
  <title>Información Producto | Uruz</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Información Del Producto</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-danger card-outline">
              <div class="card-header">
                <h5 class="m-0">Formulario para actualizar un producto</h5>
              </div>

                <?php cargarInfoProducto() ?>
                
              <!-- <form action="../../controller/insertProductoA.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label for="CodproductoImput">Codigo del producto</label>
                      <input type="number" name="Cod_producto" class="form-control" id="CodproductoImput" placeholder="codigo del producto" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="nombreProductoImput">Nombre producto</label>
                      <input type="text" name="Nombre_producto" class="form-control" id="nombreProductoImput" placeholder="Nombre del producto" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="idmarcaImput">Marca</label>
                      <input type="text" name="Marca" class="form-control" id="idmarcaImput" placeholder="Nombre de la marca del producto">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="nitproveedorImput">NIT Proveedor</label>
                      <input type="number" name="Nit_proveedor" class="form-control" id="nitproveedorImput" placeholder="Nit de la empresa del proveedor" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="precioImput">Precio del producto</label>
                      <input type="number" name="Precio_producto" class="form-control" id="precioImput" placeholder="Valor del producto" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="fotoproductoinput" class="form-label">Imagen del producto</label>
                      <input type="file" accept=".jpg, .png, .gif, .jpeg" name="Foto_producto" class="form-control" id="fotoproductoinput" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="descripcionProductoimput">Descripcion del Producto</label>
                      <textarea class="form-control" name="Descripcion_producto" id="descripcionProductoimput" cols="30" rows="4" placeholder="Descipcion breve de como es el producto" required></textarea>
                    </div>
                  </div>
                </div>
