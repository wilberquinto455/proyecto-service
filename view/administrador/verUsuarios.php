<!-- enlazamos las dependencias necesarias para pintar la tabla de usuarios que esta en el controlador -->
...
<head>
  ...
  <title>Vista Usuarios | Timeout</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Vista De Los Usuarios</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-danger card-outline">
              <div class="card-header">
                <h5 class="m-0">Usuarios registrados en el sistema</h5>
              </div>
              <div class="card-body">
...
<!-- el siguiente script es para modificar contenidos del boton copiar de la tabla -->
<script src="../dashboard/plugins/datatables-buttons/js/buttons.html5.min.js"></script>
<!-- el siguiente script es para modificar contenidos del boton imprimir de la tabla -->
<script src="../dashboard/plugins/datatables-buttons/js/buttons.print.min.js"></script>
<!-- el siguiente script es para modificar contenidos del boton visibilidad de la tabla -->
