...
<head>
  ...
  <title>Registrar Producto | Timeout</title>
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-danger card-outline">
              <div class="card-header">
                <h5 class="m-0">Formulario para el registro de un producto</h5>
              </div>
              <form action="../../controller/insertProductoVendedor.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label for="CodproductoImput">Código del producto</label>
                      <input type="number" name="Cod_producto" class="form-control" id="CodproductoImput" placeholder="Código del producto" required>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="Marca" class="form-control" id="idmarcaImput" placeholder="Nombre de la marca del producto (opcional)">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <textarea class="form-control" name="Descripcion_producto" id="descripcionProductoimput" cols="30" rows="3" placeholder="Descipción breve de como es el producto" required></textarea>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
