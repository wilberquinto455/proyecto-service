...
<head>
  ...
  <title>Facturación | Timeout</title>
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-danger card-outline">
              <div class="card-header">
                <h5 class="m-0">Formulario para el registro de una venta</h5>
              </div>
              <form id="formularioV" action="../../controller/insertVentaVendedor.php" method="POST">
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label for="idempleadoImput">Id del empleado</label> 
                      <input type="number" name="ID_empleado" class="form-control" id="idempleadoImput" placeholder="Id del empleado" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="IdclienteImput">No. de documento del cliente</label>
                      <input type="number" class="form-control" name="ID_cliente" id="IdclienteImput" placeholder="No. de documento" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="codigoImput">Código del producto</label>
                      <input type="number" class="form-control" name="Cod_producto" id="codigoImput" placeholder="Código del producto" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="cantidadImput">Cantidad del producto</label>
                      <input type="number" class="form-control" name="Cantidad_producto" id="cantidadImput" placeholder="Cantidad del producto" required>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" class="form-control" name="garantia" id="garantiaImput" placeholder="Garantía en días (opcional)">
                    </div>
                  </div>
                </div>
...
?>
<!-- alerta de totalizacion, se encuntra en consultasA debido a errores por las variables $_SESSION -->
<?php
  if (isset($_SESSION['alerta'])){
    // pasamos la variable sesion a una variable
    $alertaE = $_SESSION['alerta'];
    // ejecutaos la variable $alertaE, que tiene el codigo de la alerta
    echo $alertaE;
    // destruimos la variable $_SESSION para que no se repita siempre que recarguemos la pag
