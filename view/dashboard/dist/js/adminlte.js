...
// código para el botn que hace que suba a arriba de la pagina
const boton = document.getElementById("btn-scroll-up");
...
window.onscroll = () => {
  if (window.scrollY > 500) {
    boton.classList.add("btn-scroll-on");
  } else {
    boton.classList.remove("btn-scroll-on");
  }
}
// fin del codigo que hace que suba a arriba de la pagina
