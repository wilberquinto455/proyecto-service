...
<head>
    <meta charset="utf-8">
    <title>Timeout | Recuperar contraseña</title>
...
<body>
    ...
    <section class="d-flex">
        ...
        <div class="main-content bg-dark">
            ...
            <div class="login">
                <div class="form-box">
                    <h1 class="text-black add-letter-space my-5">Recuperar contraseña</h1>
                    <form action="../../controller/getPassword.php" method="POST" id="login-1"
                        class="formulario-login">
                        <input class="form-control mb-3" name="correo" type="email" placeholder="Email registrado" required>
                        <input class="form-control mb-3" name="documentoIng" type="number" placeholder="Número de documento" required>
                        <button type="submit" class="btn btn-primary font-weight-bold mt-3">Enviar datos</button>
                    </form>
                </div>
            </div>
    ...
    <script>
        function mostrarClaveE(){
            var c1 = document.getElementById("ClaveE");
            if (c1.type === "password") {
                c1.type = "text";
            } else {
                c1.type = "password";
